      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 antialiased overflow-x-hidden transition-colors duration-300">
        ...
        <main className="max-w-4xl mx-auto px-6 pb-24">
          ...
          <div className="grid gap-8">
            {/* Card Principal */}
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-md border border-gray-200 dark:border-gray-700 transition-colors card-hover">
              <div className="flex flex-col md:flex-row gap-6 mb-8">
                ...
                {/* Match Score */}
                <div className="flex flex-col items-center justify-center px-8 border-l border-gray-200 dark:border-gray-700">
              ...
              <button
                ...
                className="w-full mt-8 py-4 btn-primary disabled:bg-gray-200 dark:disabled:bg-gray-800 disabled:text-gray-400 rounded-2xl text-base flex items-center justify-center gap-2 cursor-pointer"
              >
                {loading ? (
              ...
              {error && (
                <div className="mt-4 px-4 py-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 rounded-xl text-sm text-red-700 dark:text-red-400">
                  {error}
                </div>
              )}
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <section className="bg-white dark:bg-gray-800 p-8 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-sm min-h-0 transition-colors card-hover">
              ...
              <section className="bg-white dark:bg-gray-800 p-8 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-sm transition-colors card-hover">
                <h3 className="text-sm font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-4">
                  Key points
                </h3>
                <div className="h-24 overflow-y-auto text-gray-400 dark:text-gray-500 italic">
